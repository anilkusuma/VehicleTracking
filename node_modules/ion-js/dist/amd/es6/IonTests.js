define(["require", "exports", "./Ion", "./IonWriteable", "./IonUnicode", "./IonSystemSymbolTable", "./IonImport", "./IonLocalSymbolTable", "./IonLowLevelBinaryWriter", "./IonBinaryWriter", "./IonBinaryWriter", "./IonSpan"], function (require, exports, Ion_1, IonWriteable_1, IonUnicode_1, IonSystemSymbolTable_1, IonImport_1, IonLocalSymbolTable_1, IonLowLevelBinaryWriter_1, IonBinaryWriter_1, IonBinaryWriter_2, IonSpan_1) {
    "use strict";
    function __export(m) {
    ...
    exports.StringSpan = IonSpan_1.StringSpan;
    exports.BinarySpan = IonSpan_1.BinarySpan;
});
